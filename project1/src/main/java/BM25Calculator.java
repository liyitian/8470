...
//        String outDirectory = "user/yli25/output";
        ...
        JavaRDD<String> tmp = bmc.loadData(inDirectory + "/part-00000");
        JavaRDD<String> uniword = bmc.loadData(outDirectory + "/uniwordSequence/part-00000");
        //word,1,2,3
...
//                    System.out.println(elements[0]);
        ...
        output.saveAsTextFile(outDirectory+"/sortedRank");
