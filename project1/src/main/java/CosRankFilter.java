...
public class CosRankFilter
{
    ...
    public static void main(final String[] args) {
        ...
        CosRankFilter us = new CosRankFilter();
...
//            requiredWord = args[0]+" "+args[1]+" "+args[2];
            inputWords = args;
        }
        ...
        String outDirectory = "output";
                ...
                rdd = us.loadData(inDirectory + "/sortedCos/part-*");
        ...
        wordIdRank.saveAsTextFile(outDirectory+"/filteredCos");
